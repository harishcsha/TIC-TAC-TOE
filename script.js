 ...
 * @create date 2019-02-10 20:27:51
 * @modify date 2019-02-10 21:45:32
 * @desc [TIC TAC TOE game from harish]
 */
...
function checkWin(x) {
  ...
  //check horizontal
  if (
    ($('.cell-0-0').text() == x && $('.cell-0-1').text() == x && $('.cell-0-2').text() == x) ||
    ($('.cell-1-0').text() == x && $('.cell-1-1').text() == x && $('.cell-1-2').text() == x) ||
    ($('.cell-2-0').text() == x && $('.cell-2-1').text() == x && $('.cell-2-2').text() == x)
  ) {
  ...
  //check vertical
  if (
    ($('.cell-0-0').text() == x && $('.cell-1-0').text() == x && $('.cell-2-0').text() == x) ||
    ($('.cell-0-1').text() == x && $('.cell-1-1').text() == x && $('.cell-2-1').text() == x) ||
    ($('.cell-0-2').text() == x && $('.cell-1-2').text() == x && $('.cell-2-2').text() == x)
  ) {
    $('.message-text').text(x + ' Won last game');
    win = true;
  }
  //check diagnal
  if (($('.cell-0-0').text() == x && $('.cell-1-1').text() == x && $('.cell-2-2').text() == x) || ($('.cell-0-2').text() == x && $('.cell-1-1').text() == x && $('.cell-2-0').text() == x)) {
    $('.message-text').text(x + ' Won last game');
    win = true;
  }
  //return
